...
class AudioRecorder {
    ...
    async startRecording() {
        ...
        try {
            ...
            // 发送录音状态更新事件
            electron_2.BrowserWindow.getAllWindows()[0]?.webContents.send('recording:status', { isRecording: true });
    ...
    async stopRecording() {
        ...
        try {
            ...
            // 发送录音状态更新事件
            electron_2.BrowserWindow.getAllWindows()[0]?.webContents.send('recording:status', { isRecording: false });
